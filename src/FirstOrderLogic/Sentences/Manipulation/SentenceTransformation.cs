    ...
    public abstract class SentenceTransformation
    {
        ...
        public virtual Term ApplyTo(Term term)
        {
            return term switch
            {
                ...
                Variable variable => ApplyTo(variable),
        ...
        /// <summary>
        /// Applies this transformation to a <see cref="Variable"/> instance.
        /// The default implementation returns a <see cref="Variable"/> of the result of calling <see cref="ApplyTo"/> on the current declaration.
        /// </summary>
        ...
        public virtual Term ApplyTo(Variable variable)
        {
            ...
            {
                return new Variable(variableDeclaration);
            }
