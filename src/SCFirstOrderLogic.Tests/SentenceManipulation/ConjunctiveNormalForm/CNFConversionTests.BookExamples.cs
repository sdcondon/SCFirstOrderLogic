...
namespace SCFirstOrderLogic.SentenceManipulation.ConjunctiveNormalForm
{
    public static partial class CNFConversionTests
    {
        ...
        private static VariableReference X => new VariableReference("x");
        private static VariableReference Y => new VariableReference("y");
        ...
        private static VariableReference StdX => new VariableReference("0:x");
