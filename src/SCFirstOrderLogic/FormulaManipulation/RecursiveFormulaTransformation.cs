...
public abstract class RecursiveFormulaTransformation : IFormulaTransformation<Formula>, ITermTransformation<Term>
{
    ...
    /// </para>
    /// <para>
    /// The default implementation uses a pattern-matching switch expression to directly invoke the ApplyTo method appropriate to the actual type of the formula.
    ...
    /// </para>
    /// </summary>
    /// <param name="formula">The formula to transform.</param>
    ...
    /// The default implementation returns an <see cref="ExistentialQuantification"/> for which the variable declaration is the result of <see cref="ApplyTo(VariableDeclaration)"/> on the existing declaration, and the formula is the result of <see cref="ApplyTo(Formula)"/> on the existing formula.
    /// </summary>
    ...
    /// The default implementation returns a <see cref="UniversalQuantification"/> for which the variable declaration is the result of <see cref="ApplyTo(VariableDeclaration)"/> on the existing declaration, and the formula is the result of <see cref="ApplyTo(Formula)"/> on the existing formula.
    /// </summary>
