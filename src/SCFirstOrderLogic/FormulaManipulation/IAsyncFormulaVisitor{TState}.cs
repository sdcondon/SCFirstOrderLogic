...
/// </para>
/// <para>
/// NB: This interface (in comparison to the non-generic <see cref="IAsyncFormulaVisitor"/>) is specifically for visitors that facilitate
...
public interface IAsyncFormulaVisitor<in TState>
{
    /// <summary>
