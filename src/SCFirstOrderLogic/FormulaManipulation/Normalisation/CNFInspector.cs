...
/// <summary>
/// Utility logic for the interrogation of formulas - specifically, the normalisation terms (standardised variables and Skolem functions) within them.
/// </summary>
public static class CNFInspector
{
    /// <summary>
    /// Returns an enumerable of all of the Terms created by the normalisation process (as opposed to featuring in the original formulas).
