...
/// <summary>
/// <para>
/// Interface for transformations of <see cref="Formula"/> instances.
/// </para>
/// <para>
/// NB: Essentially an interface for visitors with a return value.
/// </para>
/// <para>
/// NB: This interface (in comparison to <see cref="IFormulaTransformation{TOut}"/>) is specifically
/// for transformations that facilitate state accumulation outside of the transformation instance itself.
/// </para>
/// </summary>
/// <typeparam name="TOut">The type that the transformation transforms the formula to.</typeparam>
/// <typeparam name="TState">The type of state that this transformation works with.</typeparam>
public interface IFormulaTransformation<out TOut, in TState>
{
    /// <summary>
