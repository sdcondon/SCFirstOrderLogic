...
public interface IAsyncFeatureVectorIndexNode<TKeyElement, TValue>
{
    /// <summary>
    ...
    /// </summary>
    IAsyncEnumerable<KeyValuePair<TKeyElement, IAsyncFeatureVectorIndexNode<TKeyElement, TValue>>> GetChildren();
    ...
    ValueTask<IAsyncFeatureVectorIndexNode<TKeyElement, TValue>?> TryGetChildAsync(TKeyElement keyElement);
    ...
    ValueTask<IAsyncFeatureVectorIndexNode<TKeyElement, TValue>> GetOrAddChildAsync(TKeyElement keyElement);
