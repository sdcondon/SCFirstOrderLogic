...
/// <summary>
/// An implementation of <see cref="IFeatureVectorIndexNode{TKeyElement, TValue}"/> that just stores things in memory. 
...
public class FeatureVectorIndexDictionaryNode<TKeyElement, TValue> : IFeatureVectorIndexNode<TKeyElement, TValue>
    where TKeyElement : notnull
{
    private readonly Dictionary<TKeyElement, IFeatureVectorIndexNode<TKeyElement, TValue>> children;
    private TValue? value;

    /// <summary>
    /// Initialises a new instance of the <see cref="FeatureVectorIndexDictionaryNode{TKeyElement, TValue}"/> class.
    /// </summary>
    ...
    /// </param>
    public FeatureVectorIndexDictionaryNode(IEqualityComparer<TKeyElement> equalityComparer)
    {
    ...
    public IReadOnlyDictionary<TKeyElement, IFeatureVectorIndexNode<TKeyElement, TValue>> Children => children;
    ...
    /// <inheritdoc/>
    public IFeatureVectorIndexNode<TKeyElement, TValue> GetOrAddChildNode(TKeyElement keyElement)
    {
        if (!children.TryGetValue(keyElement, out var node))
        {
            node = new FeatureVectorIndexDictionaryNode<TKeyElement, TValue>();
