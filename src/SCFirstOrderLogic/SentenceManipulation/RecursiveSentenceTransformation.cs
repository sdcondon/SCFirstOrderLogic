...
namespace SCFirstOrderLogic.SentenceManipulation
{
    ...
    public abstract class RecursiveSentenceTransformation : ISentenceTransformation<Sentence>, ITermTransformation<Term>
    {
        ...
        /// For whatever reason (pattern-matching/switch expression compilation wizardry..), this is faster than calling <see cref="Sentence.Accept{TOut}(ISentenceTransformation{TOut})"/>.
        /// </summary>
