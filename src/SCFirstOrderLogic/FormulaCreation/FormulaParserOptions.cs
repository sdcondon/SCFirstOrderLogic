...
/// <summary>
/// Container for configuration options for <see cref="FormulaParser"/> instances.
/// </summary>
...
/// </para>
/// </param>
public record FormulaParserOptions(
...
{
    /// <summary>
    /// Default formula parser options, that just use the symbol text as the identifier for returned predicates, functions and variables.
    /// </summary>
    public static FormulaParserOptions Default { get; } = new(s => s, s => s, s => s);
}
