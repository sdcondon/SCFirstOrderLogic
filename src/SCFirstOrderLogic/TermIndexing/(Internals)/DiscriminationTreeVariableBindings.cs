...
internal class DiscriminationTreeVariableBindings
{
    ...
    // Worth a test at some point perhaps (maybe after looking at substitution trees in general - something to add to FormulaManipulation.VariableManipulation, perhaps?).
