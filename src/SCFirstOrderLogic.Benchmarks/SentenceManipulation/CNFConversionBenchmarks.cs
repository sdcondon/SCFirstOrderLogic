...
namespace SCFirstOrderLogic.SentenceManipulation
{
    ...
    public class CNFConversionBenchmarks
    {
        ...
        public static Sentence DoCNFConversion_ProductionVersion() => new CNFConversion().ApplyTo(NonTrivialSentence);

        [Benchmark]
        public static Sentence DoCNFConversion_WithoutTypeSwitch() => AltCNFConversion_WithoutTypeSwitch.ApplyTo(NonTrivialSentence);
    }
}
