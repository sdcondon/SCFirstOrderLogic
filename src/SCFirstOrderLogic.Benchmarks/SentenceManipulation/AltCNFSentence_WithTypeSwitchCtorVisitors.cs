...
namespace SCFirstOrderLogic.SentenceManipulation
{
    ...
    /// </summary>
    public class AltCNFSentence_WithTypeSwitchCtorVisitors
    {
        /// <summary>
        ...
        public AltCNFSentence_WithTypeSwitchCtorVisitors(Sentence sentence)
        {
        ...
        /// </summary>
        public IReadOnlyCollection<AltCNFClause_WithTypeSwitchCtorVisitors> Clauses { get; }
        ...
        /// </remarks>
        public static implicit operator AltCNFSentence_WithTypeSwitchCtorVisitors(Sentence sentence) => new(sentence);
        ...
        {
            private readonly ICollection<AltCNFClause_WithTypeSwitchCtorVisitors> clauses;

            public CNFClauseFinder(ICollection<AltCNFClause_WithTypeSwitchCtorVisitors> clauses) => this.clauses = clauses;
            ...
            public override void Visit(Sentence sentence)
            {
                ...
                else
                {
                    ...
                    clauses.Add(new AltCNFClause_WithTypeSwitchCtorVisitors(sentence));
                }
            }
        }
    }
