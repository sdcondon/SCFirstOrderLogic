...
namespace SCFirstOrderLogic.SentenceManipulation
{
    ...
    /// </remarks>
    public class CNFLiteral_WithoutTypeSwitch : IEquatable<CNFLiteral_WithoutTypeSwitch>
    {
        /// <summary>
        ...
        public CNFLiteral_WithoutTypeSwitch(Sentence sentence)
        {
        ...
        public CNFLiteral_WithoutTypeSwitch(Predicate predicate, bool isNegated)
        {
            Predicate = predicate;
            IsNegated = isNegated;
        }
        ...
        /// <inheritdoc />
        public override bool Equals(object? obj) => obj is CNFLiteral_WithoutTypeSwitch literal && Equals(literal);

        /// <inheritdoc />
        public bool Equals(CNFLiteral_WithoutTypeSwitch? other)
        {
        ...
        public static explicit operator CNFLiteral_WithoutTypeSwitch(Sentence sentence)
        {
            try
            {
                return new CNFLiteral_WithoutTypeSwitch(sentence);
            }
        ...
        public static implicit operator CNFLiteral_WithoutTypeSwitch(Predicate predicate) => new(predicate);
    }
}