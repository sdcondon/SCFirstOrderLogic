...
namespace SCFirstOrderLogic.SentenceManipulation
{
    ...
    /// </remarks>
    public class CNFLiteral_WithTypeSwitch : IEquatable<CNFLiteral_WithTypeSwitch>
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="CNFLiteral_WithTypeSwitch"/> class.
        /// </summary>
        ...
        public CNFLiteral_WithTypeSwitch(Sentence sentence)
        {
        ...
        public CNFLiteral_WithTypeSwitch(Predicate predicate, bool isNegated)
        {
            Predicate = predicate;
            IsNegated = isNegated;
        }
        ...
        /// <inheritdoc />
        public override bool Equals(object? obj) => obj is CNFLiteral_WithTypeSwitch literal && Equals(literal);

        /// <inheritdoc />
        public bool Equals(CNFLiteral_WithTypeSwitch? other)
        {
        ...
        public static explicit operator CNFLiteral_WithTypeSwitch(Sentence sentence)
        {
            try
            {
                return new CNFLiteral_WithTypeSwitch(sentence);
            }
        ...
        public static implicit operator CNFLiteral_WithTypeSwitch(Predicate predicate) => new(predicate);
    }
}