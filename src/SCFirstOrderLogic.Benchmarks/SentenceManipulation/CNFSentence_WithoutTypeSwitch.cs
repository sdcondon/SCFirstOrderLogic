...
namespace SCFirstOrderLogic.SentenceManipulation
{
    ...
    /// </summary>
    public class CNFSentence_WithoutTypeSwitch
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="CNFSentence_WithoutTypeSwitch"/> class, implicitly converting the provided sentence to CNF in the process.
        /// </summary>
        /// <param name="sentence">The sentence to (convert and) represent.</param>
        public CNFSentence_WithoutTypeSwitch(Sentence sentence)
        {
            var cnfSentence = new CNFConversion().ApplyTo(sentence);
            var clauses = new List<CNFClause_WithoutTypeSwitch>();
        ...
        /// </summary>
        public IReadOnlyCollection<CNFClause_WithoutTypeSwitch> Clauses { get; }
        ...
        /// </remarks>
        public static implicit operator CNFSentence_WithoutTypeSwitch(Sentence sentence) => new(sentence);
        ...
        {
            private readonly ICollection<CNFClause_WithoutTypeSwitch> clauses;

            public CNFClauseFinder(ICollection<CNFClause_WithoutTypeSwitch> clauses) => this.clauses = clauses;
            ...
            public override void Visit(Sentence sentence)
            {
                ...
                else
                {
                    ...
                    clauses.Add(new CNFClause_WithoutTypeSwitch(sentence));
                }
            }
        }
    }
