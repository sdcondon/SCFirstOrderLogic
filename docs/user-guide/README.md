...
Instances of these classes can be assembled into a tree structure to represent sentences of first order logic.
  ...
  * **`SentenceManipulation`:** Assorted logic for the manipulation of sentences. Contains classes for conversion to and representation of [conjunctive normal form](https://en.wikipedia.org/wiki/Conjunctive_normal_form). Also contains some interfaces and base classes for sentence visitors and transformations.
